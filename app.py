...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "VN":
        return "uid=4403616633&password=F3A0DB3AD065FB567D6D86AF8DE34C46CB08EC3F0A228E90137B411FD5273BBA"
    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=4702452255&password=LUANORI-QXETYACY2-DEV"
    else:
        return "uid=4719720114&password=NAJMI_FF_EXPERIMENTNY9V8WIFG"
